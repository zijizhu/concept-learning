...
python eval.py -e logs/CUB_runs/dev_train_CUB_crop
...
python eval.py -e logs/CUB_runs/dev_train_CUB_custom_crop
python train_net.py --name dev_train_CUB_full_crop --config_path configs/dev_train_CUB_full.yaml --options DATASET.AUGMENTATION=crop
python eval.py -e logs/CUB_runs/dev_train_CUB_full_crop
